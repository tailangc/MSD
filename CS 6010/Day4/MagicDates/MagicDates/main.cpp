...
int main() {
    ...
    if(std::stoi(date.substr(0,2)) < 1 || std::stoi(date.substr(0,2)) >12 ||std::stoi(date.substr(3,2)) <1 || std::stoi(date.substr(3,2)) > 31 || std::stoi(date.substr(6,4)) < 1000 || date.length() > 10){
