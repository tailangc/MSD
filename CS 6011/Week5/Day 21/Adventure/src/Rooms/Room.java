...
public class Room {
    ...
    protected void setPlaque_(String info){plaque_ = info;}
    ...
    public void addConnection(Room room) {
        if (doors_.contains(room)) {
            System.out.println("WARNING: tried to add " + room.name_ + " to " +
                    name_ + " but it already is connected.");
        } else {
            doors_.add(room);
        }
