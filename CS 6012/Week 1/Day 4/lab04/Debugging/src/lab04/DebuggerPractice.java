...
public class DebuggerPractice {
  ...
  public static void main(String[] args) {
    ...
    // Part 1
     ...
     System.out.println("Binary search1 is broken");
     if(Part1.binarySearch(arr1, 0) == true)
         System.out.println("Binary search2 is broken");
     if(Part1.binarySearch(arr2, 20) == false)
     System.out.println("Binary search3 is broken");
     if(Part1.binarySearch(arr2,
     18) == true) System.out.println("Binary search4 is broken");
